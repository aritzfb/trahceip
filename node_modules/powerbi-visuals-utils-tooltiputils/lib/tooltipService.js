...
export function createTooltipServiceWrapper(tooltipService, rootElement, handleTouchDelay = DefaultHandleTouchDelay, getEventMethod = getEvent) {
...
export class TooltipServiceWrapper {
    ...
    makeTooltipEventArgs(rootNode, isPointerEvent, isTouchEvent) {
        let target = this.getEvent().target, data = select(target).datum();
